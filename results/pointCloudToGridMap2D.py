...
parser.add_argument('--point_cloud',            dest='point_cloud_fname',           default='map_pts_and_keyframes.txt',    help='file name of map_pts_and_keyframes')
parser.add_argument('--keyframe_trajectory',    dest='keyframe_trajectory_fname',   default='key_frame_trajectory.txt',     help='file name of key_frame_trajectory')
parser.add_argument('--scale',                  dest='scale_factor',                default=1, type=int,                    help='scale factor')
